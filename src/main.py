...
from models import MEI, DistMult, CP, CPh, SimplE, ComplEx, RotatE, Quaternion, W2V, W2Vh, Random
...
def get_parser():
    ...
    parser.add_argument('--lambda_rowrelnorm', default=.0, type=float, help='weight of rowrel norm loss to push rowrel norm in addition to push mr ortho: .0, 1e-7 ... 1e0')
